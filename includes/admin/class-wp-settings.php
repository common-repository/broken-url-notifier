 ...
 * @author keesiemeijer
 */
if ( !class_exists( 'Broken_Url_Notifier_Settings' ) ) {
	class Broken_Url_Notifier_Settings {
		...
		public function init( $pages, $page_hook = '' ) {
			...
			if ( !class_exists( 'Broken_Url_Notifier_Settings_Fields' ) ) {
				$this->debug  .= "Error: class Broken_Url_Notifier_Settings_Fields doesn't exist<br/>";
			}
			...
			$this->fields = new Broken_Url_Notifier_Settings_Fields( get_settings_errors() );
